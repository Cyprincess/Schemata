...
public class TestFixture
{
    public TestFixture() {
        ...
        Repository
           .Setup(r => r.SingleOrDefaultAsync(It.IsAny<Func<IQueryable<Student>, IQueryable<Student>>>(),
                                              It.IsAny<CancellationToken>()))
        ...
        var builder = WebApplication.CreateBuilder()
                                    .UseSchemata(schema => {
                                         ...
                                         schema.UseResource().MapHttp().Use<Student, Student, Student, Student>();
    ...
    public (ResourceController<TEntity, TRequest, TDetail, TSummary>, DefaultHttpContext) CreateResourceController<
