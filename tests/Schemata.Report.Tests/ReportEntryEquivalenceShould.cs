...
public class ReportEntryEquivalenceShould
{
    ...
    public async Task Run_Facade_Continues_Command_Context_Into_Report_Advisors() {
        ...
        using var provider = ReportTestHost.Create(
            ...
            configure: services => {
                services.AddSingleton<ICommandAdvisor<RunReportRequest>>(commandAdvisor);
    ...
    public async Task Generate_Facade_Dispatches_Wire_Command_To_Scheduler() {
        ...
        var commandAdvisor = new Mock<ICommandAdvisor<GenerateReportRequest>>();
        ...
        commandAdvisor.Setup(value => value.AdviseAsync(
                      ...
                      .Callback((AdviceContext _, GenerateReportRequest request, CancellationToken _) =>
                          dispatched = request)
    ...
    private sealed class RecordingRunCommandAdvisor : ICommandAdvisor<RunReportRequest>
    {
        public int Order => 0;
