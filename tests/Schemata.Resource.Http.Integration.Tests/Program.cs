...
static string ResolveContentRoot() {
    ...
    while (dir != null) {
        if (File.Exists(Path.Combine(dir.FullName, "Schemata.Resource.Http.Integration.Tests.csproj"))) {
            return dir.FullName;
        }
    ...
    // The test project is at <repo root>/tests/Schemata.Resource.Http.Integration.Tests.
