...
public class TestFixture
{
    public TestFixture() {
        ...
        Workflows = [
            new() {
                Uid = Guid.NewGuid(), InstanceType = typeof(Order).FullName!, InstanceUid = Orders[0].Uid,
            },
            new() {
                Uid = Guid.NewGuid(), InstanceType = typeof(Order).FullName!, InstanceUid = Orders[1].Uid,
            },
        ];
