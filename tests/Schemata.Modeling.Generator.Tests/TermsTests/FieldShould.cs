...
public class FieldShould
{
    ...
    [InlineData("Foo bar[not null, primary key, auto increment]",
                "Foo",
                "bar",
                false,
                null,
                new[] { "Required", "PrimaryKey", "AutoIncrement" })]
    [InlineData("Foo bar {}", "Foo", "bar")]
    ...
    [InlineData("""
                ...
                null,
                null,
                new[] { "Default", "0", "Length", "11" })]
    [InlineData("string bar[required]{default ''}",
                "string",
                "bar",
                false,
                null,
