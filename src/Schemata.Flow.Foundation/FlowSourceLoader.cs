...
)
{
    ...
    public ValueTask<StartProcessRequest> CreateRequestAsync(
    ...
    {
        ValueTask<StartProcessRequest> CreateRequestAsync(
            IServiceProvider    services,
            string              definitionName,
            string              source,
            StartProcessOptions options,
    ...
    {
        public async ValueTask<StartProcessRequest> CreateRequestAsync(
            IServiceProvider    services,
            string              definitionName,
            string              source,
            StartProcessOptions options,
        ...
        private static void Apply(ResourceRequestContainer<TSource> container, string source) {
            ...
            container.ApplyWhere(r => r.Name == leaf);
            container.ApplyWhere(descriptor.BuildParentPredicate<TSource>(parents));
        }
    }
}