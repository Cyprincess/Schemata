...
public sealed class SchemataAuthorizationGrpcFeature<TApp, TAuth, TScope> : FeatureBase
    where TApp : SchemataApplication
    where TAuth : SchemataAuthorization
    where TScope : SchemataScope
{
    public const int DefaultPriority = SchemataAuthorizationFeature<TApp, TAuth, TScope>.DefaultPriority + 200_000;
    ...
    public override void ConfigureServices(
        ...
        resources.Use<SchemataToken, SchemataToken, SchemataToken, SchemataToken>([GrpcResourceAttribute.Name]);
    }
}
