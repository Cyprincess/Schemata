...
/// <remarks>
/// Invoked during <see cref="ResourceOperationHandler{TEntity, TRequest, TDetail, TSummary}.GetAsync">GetAsync</see> after <see cref="IResourceRequestAdvisor{TEntity}"/>.
/// Advisors receive the <see cref="GetRequest"/> containing the resource name.
