...
/// <remarks>
/// Invoked during <see cref="ResourceOperationHandler{TEntity, TRequest, TDetail, TSummary}.CreateAsync">CreateAsync</see> after the request has been mapped to an entity and parent
