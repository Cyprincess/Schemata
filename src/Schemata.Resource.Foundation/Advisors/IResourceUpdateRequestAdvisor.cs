...
/// <remarks>
/// Invoked during <see cref="ResourceOperationHandler{TEntity, TRequest, TDetail, TSummary}.UpdateAsync">UpdateAsync</see> after <see cref="IResourceRequestAdvisor{TEntity}"/> and before
