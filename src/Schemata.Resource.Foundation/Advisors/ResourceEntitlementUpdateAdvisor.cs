...
public sealed class ResourceEntitlementUpdateAdvisor<TEntity, TRequest>(IEntitlementProvider<TEntity, TRequest> entitlement)
    ...
    where TRequest : class, ICanonicalName
{
    ...
    public async Task<AdviseResult> AdviseAsync(
        ...
        var expression = await entitlement.GenerateEntitlementExpressionAsync(
            new() { Operation = nameof(Operations.Update), Request = request }, principal, ct);
