...
/// <remarks>
/// Invoked during <see cref="ResourceOperationHandler{TEntity, TRequest, TDetail, TSummary}.DeleteAsync">DeleteAsync</see> after <see cref="IResourceRequestAdvisor{TEntity}"/>.
