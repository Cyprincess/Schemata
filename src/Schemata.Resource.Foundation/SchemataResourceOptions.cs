...
public sealed class SchemataResourceOptions
{
    ...
    /// <summary>
    ///     Gets or sets the authentication scheme used to authenticate requests for resource endpoints.
    ///     When set, resource controllers and gRPC services authenticate with this scheme before advisors run.
