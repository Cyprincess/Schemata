...
{
    /// <summary>
    ///     Adds bearer token authentication. The default scheme is specified by
    ///     <see cref="AuthenticationScheme" />.
    ///     <para>
    ///         Bearer tokens can be obtained by calling
    ///         <see
    ///             cref="AuthenticationHttpContextExtensions.SignInAsync(Microsoft.AspNetCore.Http.HttpContext,string?,System.Security.Claims.ClaimsPrincipal)" />
    ///         .
    ///     </para>
    /// </summary>
    ...
    public static AuthenticationBuilder AddBearerToken(this AuthenticationBuilder builder) {
        return builder.AddBearerToken(BearerTokenDefaults.AuthenticationScheme);
    }
    ...
    public static AuthenticationBuilder AddBearerToken(
        ...
        return builder.AddBearerToken(authenticationScheme, _ => { });
    }

    /// <summary>
    ///     Adds bearer token authentication. The default scheme is specified by
    ///     <see cref="BearerTokenDefaults.AuthenticationScheme" />.
    ///     <para>
    ///         Bearer tokens can be obtained by calling
    ///         <see
    ///             cref="AuthenticationHttpContextExtensions.SignInAsync(Microsoft.AspNetCore.Http.HttpContext,string?,System.Security.Claims.ClaimsPrincipal)" />
    ...
    public static AuthenticationBuilder AddBearerToken(
        ...
        return builder.AddBearerToken(BearerTokenDefaults.AuthenticationScheme, configure);
    }
    ...
    public static AuthenticationBuilder AddBearerToken(
        ...
        builder.Services.TryAddEnumerable(ServiceDescriptor
           .Singleton<IConfigureOptions<JsonOptions>, BearerTokenConfigureJsonOptions>());
        builder.Services.TryAddEnumerable(ServiceDescriptor
           .Singleton<IConfigureOptions<BearerTokenOptions>, BearerTokenConfigureOptions>());
