...
public sealed class AdviceRequestEnrollValidation<TUser>(SchemataUserManager<TUser> users) : IIdentityRequestAdvisor<AuthenticatorRequest>
    where TUser : SchemataUser, new()
{
    #region IIdentityRequestAdvisor<AuthenticatorRequest> Members

    public int Order => AdviceRequestEnrollValidation.DefaultOrder;
