...
/// </summary>
/// <remarks>
///     Set via the <see cref="Schemata.Entity.Repository.RepositoryExtensions.SuppressQueryCache(Schemata.Entity.Repository.IRepository)" /> extension method on <see cref="Schemata.Entity.Repository.IRepository" /> or <see cref="Schemata.Entity.Repository.IRepository{TEntity}" />.
...
/// </remarks>
internal sealed class SuppressQueryCache;
