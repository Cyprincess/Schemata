...
/// <summary>
///     Runs advisor pipelines that pass nine arguments to each advisor.
/// </summary>
/// <typeparam name="TAdvisor">An advisor interface implementing <see cref="IAdvisor{T1, T2, T3, T4, T5, T6, T7, T8, T9}" />.</typeparam>
...
public static class AdviceRunner<TAdvisor, T1, T2, T3, T4, T5, T6, T7, T8, T9>
    where TAdvisor : IAdvisor<T1, T2, T3, T4, T5, T6, T7, T8, T9>
{
    /// <summary>
    ...
    public static async Task<AdviseResult> RunAsync(
        ...
        foreach (var advisor in advisors) {
            ...
            var result = await advisor.AdviseAsync(ctx, a1, a2, a3, a4, a5, a6, a7, a8, a9, ct);
