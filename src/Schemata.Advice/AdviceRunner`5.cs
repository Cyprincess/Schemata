...
/// <summary>
///     Runs advisor pipelines that pass four arguments to each advisor.
/// </summary>
/// <typeparam name="TAdvisor">An advisor interface implementing <see cref="IAdvisor{T1,T2,T3,T4}" />.</typeparam>
