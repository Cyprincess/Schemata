...
public sealed class AdviceDestinationProfile : IDestinationAdvisor
{
    /// <summary>The default advisor ordering value.</summary>
    public const int DefaultOrder = AdviceDestinationSubject.DefaultOrder + 10_000_000;
    ...
    public Task<AdviseResult> AdviseAsync(
        ...
        switch (claim.Type) {
            ...
            case IdentityClaims.PreferredUsername:
            case Claims.Profile:
            case Claims.Picture:
            case Claims.Website:
            case Claims.Gender:
