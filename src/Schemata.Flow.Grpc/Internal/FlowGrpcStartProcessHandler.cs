...
/// <summary>gRPC resource-method handler for starting process instances with transport-loaded sources.</summary>
public sealed class FlowGrpcStartProcessHandler(FlowRunner runner, FlowGrpcSourceLoader sources)
...
/// <summary>Loads source entities for gRPC start requests before invoking Flow.</summary>
public sealed class FlowGrpcSourceLoader(
