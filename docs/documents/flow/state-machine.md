...
| Method                    | Behavior                                                                                                                                                                                                          |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `StartAsync`              | Finds the start event, follows its outgoing flow, and writes the first transition row. A none task rests Active on arrival; parking at a gateway or completing through an end event takes an explicit `AdvanceAsync`, matching the BPMN engine. |
